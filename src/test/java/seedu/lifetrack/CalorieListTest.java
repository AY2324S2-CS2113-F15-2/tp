...
public class CalorieListTest {
    ...
    public void testPrintCalorieListNonEmpty() {
        ...
        String expectedOutput = ADDED_ENTRY_HEADER + lineSeparator +
                ...
                "\t 1. \t Calories ID: 1, Date: 2024-03-14, Description: burger king, Calories: 200" + lineSeparator +
    ...
    public void testPrintCalorieListMultipleEntries() {
        ...
        expectedOutput.append("\t Your Caloric List:")
                ...
                .append(lineSeparator)
                .append("\t 1. \t Calories ID: 1, Date: 2024-03-14, Description: burger king, Calories: 200")
                .append(lineSeparator)
                .append("\t 2. \t Calories ID: 3, Date: 2024-03-14, Description: acai, Calories: 500")
                .append(lineSeparator)
                .append("\t 3. \t Calories ID: 5, Date: 2024-03-14, Description: commhall dinner, Calories: 300")
                .append(lineSeparator)
                .append(lineSeparator)
                .append("\t Your Caloric Outflow List:")
                .append(lineSeparator)
                .append("\t 1. \t Calories ID: 2, Date: 2024-03-14, Description: Walk, Calories: 150")
                .append(lineSeparator)
                .append("\t 2. \t Calories ID: 4, Date: 2024-03-14, Description: Run, Calories: 250")
                .append(lineSeparator);
    ...
    public void testAddEntry_addDifferentDates_datesSortedCorrectly() {
        ...
        expectedOutput.append("\t Your Caloric List:")
                ...
                .append("\t Your Caloric Inflow List:")
                .append(lineSeparator)
                .append("\t 1. \t Calories ID: 5, Date: 2021-01-11, Description: commhall dinner, Calories: 300")
                .append(lineSeparator)
                .append("\t 2. \t Calories ID: 3, Date: 2022-02-22, Description: acai, Calories: 500")
                .append(lineSeparator)
                .append("\t 3. \t Calories ID: 1, Date: 2024-03-14, Description: burger king, Calories: 200")
                .append(lineSeparator)
                .append(lineSeparator)
                .append("\t Your Caloric Outflow List:")
                .append(lineSeparator)
                .append("\t 1. \t Calories ID: 6, Date: 2021-01-11, Description: play pool, Calories: 69")
                .append(lineSeparator)
                .append("\t 2. \t Calories ID: 2, Date: 2022-02-22, Description: Walk, Calories: 150")
                .append(lineSeparator)
                .append("\t 3. \t Calories ID: 4, Date: 2024-03-14, Description: Run, Calories: 250")
                .append(lineSeparator);
        assertEquals(expectedOutput.toString(), outputStream.toString());
    ...
    public void testDeleteEntry_deleteUsingEntryID_correctlyDeletesBasedOnEntryID() {
        ...
        expectedOutput.append("\t Your Caloric List:")
                ...
                .append("\t Your Caloric Inflow List:")
                .append(lineSeparator)
                .append("\t 1. \t Calories ID: 1, Date: 2022-02-22, Description: burger king, Calories: 200")
                .append(lineSeparator)
                .append(lineSeparator)
                .append("\t Your Caloric Outflow List:")
                .append(lineSeparator)
                .append("\t 1. \t Calories ID: 2, Date: 2022-02-22, Description: Walk, Calories: 150")
                .append(lineSeparator);
        assertEquals(expectedOutput.toString(), outputStream.toString());
        assertEquals(2, calorieList.getSize());
    }
    ...
    public void testAddEntry_addAndDeleteEntries_entryIDIncrementsProperly() {
        ...
        expectedOutput.append("\t Your Caloric List:")
                ...
                .append("\t 1. \t Calories ID: 1, Date: 2022-02-22, Description: burger king, Calories: 200")
                .append(lineSeparator)
                .append("\t 2. \t Calories ID: 4, Date: 2022-02-22, Description: yong tau foo, Calories: 688 " +
                        "(C: 10, P: 10, F: 10)")
                .append(lineSeparator)
                .append(lineSeparator)
                .append("\t Your Caloric Outflow List:")
